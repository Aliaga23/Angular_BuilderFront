  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.user) {
        ...
        // with the data we have from the login form
        const userData = {
          id: response.user_id || `user_${Date.now()}`, // Use user_id from response or generate a temporary one
        ...
        console.log("Created user data from login form:", userData)
      }
